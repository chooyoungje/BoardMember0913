...
<body>
	<form action="memberupdateprocess" method="post" name="memberupdateform" enctype="multipart/form-data">
	...
	이메일<input  type="email" id="memail" name="memail" value="${mdto.memail}">
            <span>@</span><input type="text" id= "memailsel" name="memail" value="${mdto.memail}">
